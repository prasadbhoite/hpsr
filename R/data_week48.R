#' Week 48 Household Pulse Survey data
#'
#' Week 48 data from the US census's Household Pulse Survey.
#'
#'
#' @format ## `data_week48`
#' A data frame with 46,801 rows and 240 columns:
#' \describe{
...
#'      \describe{
#'        \item{}{Question Wording- For all those people counted in the previous question, has the coronavirus pandemic resulted in any of the changes listed below? Select all that apply.}
...
#'        \item{}{Description- Changes to post-sec education plans}
#'        \item{}{Values- 1) All plans to take classes this term have been canceled., -99) Question seen but category not selected, -88) Missing / Did not report}
...
#'        \item{}{Question Wording- For all those people counted in the previous question, has the coronavirus pandemic resulted in any of the changes listed below? Select all that apply.}
#'        \item{}{Description- Changes to post-sec education plans}
#'        \item{}{Values- 1) Classes will be in different formats this term (for example, change from in-person to online)., -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- TNUM_PS > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'        \item{}{Question Wording- For all those people counted in the previous question, has the coronavirus pandemic resulted in any of the changes listed below? Select all that apply.}
#'        \item{}{Description- Changes to post-sec education plans}
#'        \item{}{Values- 1) Fewer classes will be taken this term, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- TNUM_PS > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'        \item{}{Question Wording- For all those people counted in the previous question, has the coronavirus pandemic resulted in any of the changes listed below? Select all that apply.}
#'        \item{}{Description- Changes to post-sec education plans}
#'        \item{}{Values- 1) More classes will be taken this term, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- TNUM_PS > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'        \item{}{Question Wording- For all those people counted in the previous question, has the coronavirus pandemic resulted in any of the changes listed below? Select all that apply.}
#'        \item{}{Description- Changes to post-sec education plans}
#'        \item{}{Values- 1) Classes are being taken from a different institution., -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- TNUM_PS > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'        \item{}{Question Wording- For all those people counted in the previous question, has the coronavirus pandemic resulted in any of the changes listed below? Select all that apply.}
#'        \item{}{Description- Changes to post-sec education plans}
#'        \item{}{Values- 1) Classes are being taken for a different kind of certificate or degree., -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- TNUM_PS > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'      \describe{
#'        \item{}{Question Wording- Why did household members’ classes this term change? Select all that apply.}
...
#'        \item{}{Universe- If PSCHNG2 = 1 or PSCHNG3 = 1 or PSCHNG4 = 1 or PSCHNG5 = 1 or PSCHNG6 = 1 or PSCHNG7 = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'      \describe{
#'        \item{}{Question Wording-In the last 7 days, have you worked or volunteered outside your home? (select one)}
...
#'   }
#'   }
#'   \item{TELEHLTH}{Personal telehealth
#'      \describe{
...
#'        \item{}{Universe- KIDS_LT5Y = 1 or KIDS_5_11Y = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'        \item{}{Description- Receipt and use of Child Tax Credit portion of tax refund (CTC)}
...
#'        \item{}{Universe- CTC_REFUND = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{CTCSPND1}{CTC spending 1
#'      \describe{
#'        \item{}{Question Wording- What did you and your household mostly spend the “Child Tax Credit” portion of your refund on? Select all that apply.}
...
#'      \describe{
#'        \item{}{Question Wording- What did you and your household mostly spend the “Child Tax Credit” portion of your refund on? Select all that apply.}
#'        \item{}{Description- Spending use of Child Tax Credit portion of 2021 tax return (CTC)}
...
#'   }
#'   }
#'    \item{PRVRIDESHR}{Rideshare Usage
#'      \describe{
...
#'   }
#'   }
#'    \item{FEWRTRANS}{Change to Rideshare Usage
#'      \describe{
#'        \item{}{Question Wording-In the last 7 days, have you taken fewer trips than you normally would have by bus, rail, or ride-sharing services, like Uber and Lyft, because of the coronavirus pandemic?}
#'        \item{}{Description-Change to rideshare usage}
#'        \item{}{Values- 1) Yes,2) No,-99) Question seen but category not selected,-88) Missing / Did not report}
#'        \item{}{Universe-PRVRIDESHR = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'   }
#'   }
#'     \item{CTC_CLAIM}{Claim Child Tax Credit
#'      \describe{
#'        \item{}{Question Wording-On your 2021 Federal tax return, did you or someone in your household claim the “Child Tax Credit,” that is the expanded credit as part of the Federal Government’s 2021 American Rescue Plan? This credit would have been claimed on line 28 of your Form 1040.}
#'        \item{}{Description-Claim Child Tax Credit (CTC) on 2021 Federal tax return}
#'        \item{}{Values-1) Yes ,2) No,3) Have not filed 2021 Federal taxes yet,-99) Question seen but category not selected,-88) Missing / Did not report}
#'        \item{}{Universe-All persons born before 2004}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'     \item{CTC_REFUND}{Refund from 2021 tax return
#'      \describe{
#'        \item{}{Question Wording-In the last 4 weeks, did you receive a refund from your 2021 tax return?}
#'        \item{}{Description-Receive a refund from 2021 tax return}
#'        \item{}{Values-1) Yes , 2) No, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-CTC_CLAIM = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'   }
#'   }
#'    \item{LEARNFMT}{Child education format
#'      \describe{
#'        \item{}{Question Wording-Thinking about the last 7 days, were any of the children in your household receiving their education with a combination of in-person learning at school and another form of learning (e.g., virtual instruction, online or paper material provided by the school) because of the pandemic?}
#'        \item{}{Description-Child educational format}
#'        \item{}{Values-1) Yes – education was provided both in-person and by other forms of learning , 2) No – all education was provided in person at school, 3) No – all education was provided using some other form of learning , -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-If ENROLLPUB > 0  or ENROLLPRV > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{SCHLHRS}{Child education format
#'      \describe{
#'        \item{}{Question Wording-During the last 7 days, on how many days did the student(s) have real time contact, that is not pre-recorded contact, with their teachers by video, in person, or by phone? Select only one answer. }
#'        \item{}{Description-Child educational format}
