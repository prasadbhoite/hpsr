#' Week 45 Household Pulse Survey data
#'
#' Week 45 data from the US census's Household Pulse Survey.
#'
#'
#' @format ## `data_week45`
#' A data frame with 61,767 rows and 219 columns:
#' \describe{
...
#'        \item{}{Values- 1) 1 vaccination,2) 2 vaccinations,3) 3 vaccinations,4) 4 or more vaccinations,5) Don’t know,-99) Question seen but category not selected,-88) Missing / Did not report}
#'        \item{}{Universe- RECVDACC = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'      \item{BRAND}{Brand Of Vaccination
#'      \describe{
#'        \item{}{Question Wording-Which brand of COVID-19 vaccine did you receive ^FIRST?}
#'        \item{}{Description-Brand of first vaccination}
#'        \item{}{Values- 1) Pfizer-Biontech,2) Moderna,3) Johnson and Johnson (Janssen),4) One of the brands that requires two initial shots, but not sure which brand,5) None of these brands,6) Don’t know,-99) Question seen but category not selected,-88) Missing / Did not report}
#'        \item{}{Universe- RECVDACC = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'      \describe{
#'        \item{}{Question Wording-Since June 1, 2021, have you applied for Unemployment Insurance (UI) benefits? Select only one answer.}
...
#'   }
#'
#'   \item{RBOOSTER}{Received or intention for Vaccine Booster
#'      \describe{
#'        \item{}{Question Wording-Did you receive (or do you plan to receive) a COVID-19 vaccine booster?}
#'        \item{}{Description-Received or intention to receive COVID-19 vaccine booster}
#'        \item{}{Values- 1) Yes, I received a booster,2) Yes, I plan to receive a booster,3) No, I do not plan to receive a booster,-99) Question seen but category not selected,-88) Missing / Did not report}
#'        \item{}{Universe-RECVDACC = 1}
#'        \item{}{Internal Notes-if NUMDOSES in (3:4) OR (BRAND = 3 AND NUMDOSES = 2) then RBOOSTER = 1}
#'   }
#'   }
#'
#'    \item{KIDDOSES_5_11Y}{Children 5 to 11 received one dose
#'      \describe{
#'        \item{}{Question Wording-Have any of the children living in your household received at least one dose of a COVID-19 vaccine?}
#'        \item{}{Description-Children  5 to 11 received at least one dose of a COVID-19 vaccine}
#'        \item{}{Values-1) Yes,2) No,3) Don't know,-99) Question seen but category not selected,-88) Missing / Did not report}
#'        \item{}{Universe-KIDS_5_11Y = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'
#'    \item{KIDDOSES_12_17Y}{Children 12 to 17 received one dose
#'      \describe{
#'        \item{}{Question Wording-Have any of the children living in your household received at least one dose of a COVID-19 vaccine?}
#'        \item{}{Description-Children  12 to 17 received at least one dose of a COVID-19 vaccine}
#'        \item{}{Values-1) Yes,2) No,3) Don't know,-99) Question seen but category not selected,-88) Missing / Did not report}
...
#'        \item{}{Values-1) Just 1-2 days, 2) 3-4 days, 3) 5 or more days, -99) Question seen but category not selected, -88) Missing / Did not report }
#'        \item{}{Universe-ACTIVITY2 = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'
