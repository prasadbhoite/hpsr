#' Week 14 Household Pulse Survey data
#'
#' Week 14 data from the US census's Household Pulse Survey.
#'
#'
#' @format ## `data_week14`
#' A data frame with 110,019 rows and 188 columns:
#' \describe{
...
#'        \item{}{Universe- All persons born before 2002}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'        \item{}{Universe- persons born before 2002}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'   }
#'   }
#'   \item{CNCLDTRPS}{Canceled trips
#'      \describe{
#'        \item{}{Question Wording- Were any of these trips canceled because of the coronavirus pandemic? Include trips you had not made travel reservations or arrangements for in your answer. Select only one answer.}
#'        \item{}{Description- Canceled planned trips}
#'        \item{}{Values- 1) Yes, 2) No, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Ask Q21d if Q21c = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'   }
#'   }
#'   \item{SNAPMNTH1}{SNAP month 1
#'      \describe{
#'        \item{}{Question Wording- In which month(s) were SNAP or food stamp benefits received?  Select all that apply.}
#'        \item{}{Description- Months in 2020 for SNAP Receipt}
#'        \item{}{Values- 1) January, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Display Q27b if Q27a = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{SNAPMNTH2}{SNAP month 2
#'      \describe{
#'        \item{}{Question Wording- In which month(s) were SNAP or food stamp benefits received?  Select all that apply.}
#'        \item{}{Description- Months in 2020 for SNAP Receipt}
#'        \item{}{Values- 1) February, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Display Q27b if Q27a = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{SNAPMNTH3}{SNAP month 3
#'      \describe{
#'        \item{}{Question Wording- In which month(s) were SNAP or food stamp benefits received?  Select all that apply.}
#'        \item{}{Description- Months in 2020 for SNAP Receipt}
#'        \item{}{Values- 1) March, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Display Q27b if Q27a = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{SNAPMNTH4}{SNAP month 4
#'      \describe{
#'        \item{}{Question Wording- In which month(s) were SNAP or food stamp benefits received?  Select all that apply.}
#'        \item{}{Description- Months in 2020 for SNAP Receipt}
#'        \item{}{Values- 1) April, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Display Q27b if Q27a = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{SNAPMNTH5}{SNAP month 5
#'      \describe{
#'        \item{}{Question Wording- In which month(s) were SNAP or food stamp benefits received?  Select all that apply.}
#'        \item{}{Description- Months in 2020 for SNAP Receipt}
#'        \item{}{Values- 1) May, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Display Q27b if Q27a = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{SNAPMNTH6}{SNAP month 6
#'      \describe{
#'        \item{}{Question Wording- In which month(s) were SNAP or food stamp benefits received?  Select all that apply.}
#'        \item{}{Description- Months in 2020 for SNAP Receipt}
#'        \item{}{Values- 1) June, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Display Q27b if Q27a = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{SNAPMNTH7}{SNAP month 7
#'      \describe{
#'        \item{}{Question Wording- In which month(s) were SNAP or food stamp benefits received?  Select all that apply.}
#'        \item{}{Description- Months in 2020 for SNAP Receipt}
#'        \item{}{Values- 1) July, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Display Q27b if Q27a = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{SNAPMNTH8}{SNAP month 8
#'      \describe{
#'        \item{}{Question Wording- In which month(s) were SNAP or food stamp benefits received?  Select all that apply.}
#'        \item{}{Description- Months in 2020 for SNAP Receipt}
#'        \item{}{Values- 1) August, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Display Q27b if Q27a = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{SNAPMNTH9}{SNAP month 9
#'      \describe{
#'        \item{}{Question Wording- In which month(s) were SNAP or food stamp benefits received?  Select all that apply.}
#'        \item{}{Description- Months in 2020 for SNAP Receipt}
#'        \item{}{Values- 1) September, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Display Q27b if Q27a = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{SNAPMNTH10}{SNAP month 10
#'      \describe{
#'        \item{}{Question Wording- In which month(s) were SNAP or food stamp benefits received?  Select all that apply.}
#'        \item{}{Description- Months in 2020 for SNAP Receipt}
#'        \item{}{Values- 1) October, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Display Q27b if Q27a = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{SNAPMNTH11}{SNAP month 11
#'      \describe{
#'        \item{}{Question Wording- In which month(s) were SNAP or food stamp benefits received?  Select all that apply.}
#'        \item{}{Description- Months in 2020 for SNAP Receipt}
#'        \item{}{Values- 1) November, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Display Q27b if Q27a = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{SNAPMNTH12}{SNAP month 12
#'      \describe{
#'        \item{}{Question Wording- In which month(s) were SNAP or food stamp benefits received?  Select all that apply.}
#'        \item{}{Description- Months in 2020 for SNAP Receipt}
#'        \item{}{Values- 1) December, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- Display Q27b if Q27a = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'   }
#'   }
#'   \item{TBEDROOMS}{Number of bedrooms
#'      \describe{
#'        \item{}{Question Wording- How many bedrooms are in your home Enter number of bedrooms (if none, enter zero).}
#'        \item{}{Description- How many bedrooms in home}
...
#'   }
#'   }
#'   \item{TUI_NUMPER}{How many received UI
#'      \describe{
#'        \item{}{Question Wording- Including yourself, how many people in your household received Unemployment Insurance (UI) benefits since March 13, 2020? Please enter a number.}
#'        \item{}{Description- UI How many}
#'        \item{}{Values- (1-40) number of people (whole number)}
#'        \item{}{Universe- Ask Q14c if # adults in household >1. This can be calculated using embedded data= Q7 – Q8. All persons born before 2002}
#'        \item{}{Internal Notes-}
#'   }
#'   }
