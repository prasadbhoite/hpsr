#' Week 59 Household Pulse Survey data
#'
#' Week 59 data from the US census's Household Pulse Survey.
#'
#'
#' @format ## `data_week59`
#' A data frame with 63,802 rows and 221 columns:
#' \describe{
...
#'   }
#'   }
#'   \item{TEST_YN}{At-home tests
#'      \describe{
#'        \item{}{Question Wording-Over the last year, have you obtained COVID-19 at-home tests?}
#'        \item{}{Description-Obtained COVID-19 tests over the past year}
#'        \item{}{Values-1) Yes, 2) No, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- All persons born before 2005}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{TEST_OBTAIN1}{Obtaining test method 1
#'      \describe{
...
#'        \item{}{Description-Method of obtaining COVID-19 tests}
#'        \item{}{Values-1) I obtained free tests through my health insurance (including mail order or at a pharmacy or store) , -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- TEST_YN = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{TEST_OBTAIN2}{Obtaining test method 2
#'      \describe{
...
#'        \item{}{Description-Method of obtaining COVID-19 tests}
#'        \item{}{Values-1) I ordered free tests from covidtests.gov or the US Postal Service, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- TEST_YN = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{TEST_OBTAIN3}{Obtaining test method 3
#'      \describe{
...
#'        \item{}{Description-Method of obtaining COVID-19 tests}
#'        \item{}{Values-1)I received free at-home tests from the local health department, my employer, my school, or another source, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- TEST_YN = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{TEST_OBTAIN4}{Obtaining test method 4
#'      \describe{
...
#'        \item{}{Description-Method of obtaining COVID-19 tests}
#'        \item{}{Values-1)I paid for tests at a pharmacy or store, and got reimbursed by my insurance, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- TEST_YN = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{TEST_OBTAIN5}{Obtaining test method 5
#'      \describe{
...
#'   }
#'   }
#'   \item{TEST_OBTAIN6}{Obtaining test method 6
#'      \describe{
#'        \item{}{Question Wording-Over the last year, how have you obtained COVID-19 at home tests?  Select all that apply. - Selected Choice -  Other, please specify}
#'        \item{}{Description-Method of obtaining COVID-19 tests}
#'        \item{}{Values-1) I paid for tests at a pharmacy or store, and did not get reimbursed by my insurance, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- TEST_YN = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
