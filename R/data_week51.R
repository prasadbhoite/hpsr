#' Week 51 Household Pulse Survey data
#'
#' Week 51 data from the US census's Household Pulse Survey.
#'
#'
#' @format ## `data_week51`
#' A data frame with 61,453 rows and 244 columns:
#' \describe{
...
#'        \item{}{Values-1932-2004}
#'        \item{}{Universe-All persons born before 2004}
#'        \item{}{Internal Notes-Topcoded 1934-2004}
#'   }
#'   }
...
#'        \item{}{Values-1) Yes, 2) No, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-All person's born before 2004}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'      \describe{
#'        \item{}{Question Wording-In the last 7 days, which best describes the primary location/setting where you worked or volunteered outside your home? Select only one answer.}
#'        \item{}{Description- Work or volunteer setting outside the home.}
#'        \item{}{Values-1) Hospital, 2) Nursing and residential healthcare facility, 3) Pharmacy, 4) Ambulatory healthcare (e.g. doctor, dentist or mental health specialist office, outpatient facility, medical and diagnostic laboratory, home health care) , 5) Social service (e.g., child, youth, family, elderly, disability services) , 6) Preschool or daycare , 7) K-12 school , 8) Other schools and instructional settings (e.g. college, university, professional, business, technical or trade school, driving school, test preparation, tutoring) , 9) First response (e.g., police or fire protection, emergency relief services) , 10)Death care (e.g., funeral home, crematory, cemetery) , 11) Correctional facility (e.g., jail, prison, detention center, reformatory) , 12) Food and beverage store (e.g., grocery store, warehouse club, supercenters, convenience store, specialty food store, bakery) , 13) Agriculture, forestry, fishing, or hunting , 14) Food manufacturing facility (e.g., meat-processing, produce packing, food or beverage manufacturing) , 15) Non-food manufacturing facility (e.g. metals, equipment and machinery, electronics) , 16) Public transit (e.g., bus, commuter rail, subway, school bus) , 17) United States Postal Service , 18) Other job deemed “essential” during the COVID-19 pandemic , 19) None of the above , -99) Question seen but category not selected, -88) Missing / Did not report, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-ANYWORK = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'      \describe{
#'        \item{}{Question Wording- Which of the following, if any, are reasons that the parents or guardians of children living in your household (only probably will / probably won’t/definitely won’t/ are unsure about whether to) get a COVID-19 vaccine for the children? (Select all that apply) }
...
#'        \item{}{Question Wording-Which of the following, if any, are reasons that the parents or guardians of children living in your household (only probably will / probably won’t/definitely won’t/ are unsure about whether to) get a COVID-19 vaccine for the children? (Select all that apply) }
#'        \item{}{Description- Why not get children vaccinated}
#'        \item{}{Values- 1) The children in this household are not members of a high-risk group, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe- if  KIDGETVAC in 2:5}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'   }
#'   }
#'      \item{NUMDOSES}{Number of doses
#'      \describe{
#'        \item{}{Question Wording-How many dose(s) of a COVID-19 vaccine have you received?}
#'        \item{}{Description-Number of doses received}
#'        \item{}{Values- 1) I received one dose of a two-shot series like Moderna or Pfizer, 2) I received 2 doses of a two-shot series or a single dose vaccine like Johnson & Johnson, -99) Question seen but category not selected,-88) Missing / Did not report}
...
#'      \describe{
#'        \item{}{Question Wording-Since January 1, 2022, have you applied for Unemployment Insurance (UI) benefits? Select only one answer.}
...
#'   }
#'   }
#'   \item{KIDGETVAC_5_11Y}{Children 5 to 11 intention on getting vaccine
#'      \describe{
#'        \item{}{Question Wording-Now that vaccines to prevent COVID-19 are available to most children, will the parents or guardians of children living in your household…}
#'        \item{}{Description-likelihood of getting vaccinated (5 to 11 years old)}
#'        \item{}{Values-1) Definitely get the children a vaccine,2) Probably get the children a vaccine,3) Be unsure about getting the children a vaccine,4) Probably NOT get the children a vaccine ,5) Definitely NOT get the children a vaccine,6) I do not know the plans for vaccination of the children under 5 in my household,-99) Question seen but category not selected,-88) Missing / Did not report}
#'        \item{}{Universe-KIDDOSESRV=2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{KIDGETVAC_12_17Y}{Children 12 to 17 intention on getting vaccine
#'      \describe{
#'        \item{}{Question Wording-Now that vaccines to prevent COVID-19 are available to most children, will the parents or guardians of children living in your household…}
#'        \item{}{Description-Intention on getting children  12 to 17 vaccine}
#'        \item{}{Values-1) Definitely get the children a vaccine,2) Probably get the children a vaccine,3) Be unsure about getting the children a vaccine,4) Probably NOT get the children a vaccine ,5) Definitely NOT get the children a vaccine,6) I do not know the plans for vaccination of the children under 5 in my household,-99) Question seen but category not selected,-88) Missing / Did not report}
#'        \item{}{Universe-KIDDOSESRV=2}
#'        \item{}{Internal Notes-}
#'   }
...
#'   }
#'   }
#'     \item{RCVEDUC1}{Children received education
#'      \describe{
#'        \item{}{Question Wording-During the last 7 days, how did the children in this household receive their education?  Select all that apply.}
#'        \item{}{Description-How children received education}
#'        \item{}{Values-1) Children received in-person instruction from a teacher at their school. -99) Question seen but category not selected. -88) Missing / Did not report}
#'        \item{}{Universe-If ENROLLPUB > 0  or ENROLLPRV > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{RCVEDUC2}{Children received education
#'      \describe{
#'        \item{}{Question Wording-During the last 7 days, how did the children in this household receive their education?  Select all that apply.}
#'        \item{}{Description-How children received education}
#'        \item{}{Values-1) Children received virtual/online instruction from a teacher in real time, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-If ENROLLPUB > 0  or ENROLLPRV > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'      \item{RCVEDUC3}{Children received education
#'      \describe{
#'        \item{}{Question Wording-During the last 7 days, how did the children in this household receive their education?  Select all that apply.}
#'        \item{}{Description-How children received education}
#'        \item{}{Values-1) Children learned on their own using on-line materials provided by their school, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-If ENROLLPUB > 0  or ENROLLPRV > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{RCVEDUC4}{Children received education
#'      \describe{
#'        \item{}{Question Wording-During the last 7 days, how did the children in this household receive their education?  Select all that apply.}
#'        \item{}{Description-How children received education}
#'        \item{}{Values-1) Children learned on their own using paper materials provided by their school, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-If ENROLLPUB > 0  or ENROLLPRV > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{RCVEDUC5}{Children received education
#'      \describe{
#'        \item{}{Question Wording-During the last 7 days, how did the children in this household receive their education?  Select all that apply.}
#'        \item{}{Description-How children received education}
#'        \item{}{Values-1) Children learned on their own using materials that were NOT provided by their school, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-If ENROLLPUB > 0  or ENROLLPRV > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{RCVEDUC6}{Children received education
#'      \describe{
#'        \item{}{Question Wording-During the last 7 days, how did the children in this household receive their education?  Select all that apply.}
#'        \item{}{Description-How children received education}
...
#'   }
#'   }
#'   \item{RCVEDUC7}{Children received education
#'      \describe{
#'        \item{}{Question Wording-During the last 7 days, how did the children in this household receive their education?  Select all that apply.}
#'        \item{}{Description-How children received education}
...
#'   }
#'   }
#'    \item{RCVEDUC8}{Children received education
#'      \describe{
#'        \item{}{Question Wording-During the last 7 days, how did the children in this household receive their education?  Select all that apply.}
#'        \item{}{Description-How children received education}
#'        \item{}{Values-1) Children were on summer break, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-If ENROLLPUB > 0  or ENROLLPRV > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{BOOSTERRV}{Received vaccine booster
#'      \describe{
#'        \item{}{Question Wording-Have you received at least one COVID-19 vaccine booster?}
#'        \item{}{Description-Received COVID-19 vaccine booster}
#'        \item{}{Values-1) Yes, 2) No, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-RECVDACC = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{WHYNOBSTR1}{Why not get booster 1
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you have not received a COVID-19 booster dose? Select all that apply.}
#'        \item{}{Description-Why not get vaccine booster booster}
#'        \item{}{Values-1) I am not yet eligible to receive a COVID-19 booster dose, -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-RECVDVACC = 1 and BOOSTERRV = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{WHYNOBSTR2}{Why not get booster 2
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you have not received a COVID-19 booster dose? Select all that apply.}
#'        \item{}{Description-Why not get vaccine booster booster}
#'        \item{}{Values-1)I plan to get a booster and am eligible, but haven’t made an appointment or haven’t had time to do it, -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-RECVDVACC = 1 and BOOSTERRV = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{WHYNOBSTR3}{Why not get booster 3
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you have not received a COVID-19 booster dose? Select all that apply.}
#'        \item{}{Description-Why not get vaccine booster booster}
#'        \item{}{Values-1) I don’t believe a COVID-19 booster is necessary , -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-RECVDVACC = 1 and BOOSTERRV = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{WHYNOBSTR4}{Why not get booster 4
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you have not received a COVID-19 booster dose? Select all that apply.}
#'        \item{}{Description-Why not get vaccine booster booster}
...
#'   }
#'   }
#'   \item{WHYNOBSTR5}{Why not get booster 5
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you have not received a COVID-19 booster dose? Select all that apply.}
#'        \item{}{Description-Why not get vaccine booster booster}
...
#'   }
#'   }
#'   \item{WHYNOBSTR6}{Why not get booster 6
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you have not received a COVID-19 booster dose? Select all that apply.}
#'        \item{}{Description-Why not get vaccine booster booster}
#'        \item{}{Values-1) I am not required to get a COVID-19 booster (by my work or school), -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-RECVDVACC = 1 and BOOSTERRV = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{WHYNOBSTR7}{Why not get booster 7
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you have not received a COVID-19 booster dose? Select all that apply.}
#'        \item{}{Description-Why not get vaccine booster booster}
#'        \item{}{Values-1) I experienced side effects from my previous dose(s) of the COVID-19 vaccine, -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-RECVDVACC = 1 and BOOSTERRV = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{WHYNOBSTR8}{Why not get booster 8
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you have not received a COVID-19 booster dose? Select all that apply.}
#'        \item{}{Description-Why not get vaccine booster booster}
#'        \item{}{Values-1) It's hard for me to get a COVID-19 booster dose because I do not have transportation or cannot get an appointment, -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-RECVDVACC = 1 and BOOSTERRV = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{WHYNOBSTR9}{Why not get booster 9
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you have not received a COVID-19 booster dose? Select all that apply.}
#'        \item{}{Description-Why not get vaccine booster booster}
#'        \item{}{Values-1) Other (please specify), -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-RECVDVACC = 1 and BOOSTERRV = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'      \item{KIDDOSESRV}{Children received one does of vaccine
#'      \describe{
#'        \item{}{Question Wording-Have any of the children living in your household received at least one dose of a COVID-19 vaccine?  Please respond “yes” if any of the children living in your household have received at least one dose, even if some of the children have not.}
#'        \item{}{Description-Children received at least one does of a Vaccine}
#'        \item{}{Values-1) Yes, 2) No, 3) Don't know, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-HHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'      \item{KIDDOSESRV_5_11Y}{Vaccinated children between 5-11
#'      \describe{
#'        \item{}{Question Wording-Are any of the children 5-11 years old fully vaccinated against COVID-19?}
#'        \item{}{Description-Fully vaccinated children between 5  - 11}
#'        \item{}{Values-1) Yes, 2) No, 3) Don't know, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-KIDDOSESRV = 1 and KIDS_5_11Y = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'      \item{KIDDOSESRV_12_17Y}{Vaccinated children between 12-17
#'      \describe{
#'        \item{}{Question Wording-Are any of the children 12-17 years old fully vaccinated against COVID-19?}
#'        \item{}{Description-Fully vaccinated children between 12 - 17}
#'        \item{}{Values-1) Yes, 2) No, 3) Don't know, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-KIDDOSESRV = 1 and KIDS_12_17Y = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'      \item{KIDBSTR_5_11Y}{Boostered children between 5-11
#'      \describe{
#'        \item{}{Question Wording-Have any of the children 5-11 years old received a booster or additional doses of a COVID-19 vaccine?}
#'        \item{}{Description-Boostered children between 5 - 11}
#'        \item{}{Values-1) Yes, 2) No, 3) Don't know, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-KIDDOSESRV_5_11Y=1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'     \item{KIDBSTR_12_17Y}{Boostered children between 12-17
#'      \describe{
#'        \item{}{Question Wording-Have any of the children 12-17 years old received a booster or additional doses of a COVID-19 vaccine?}
#'        \item{}{Description-Boostered children between 12 - 17}
#'        \item{}{Values-1) Yes, 2) No, 3) Don't know, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-KIDDOSESRV_12_17Y=1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'   }
#'   }
#'      \item{WHENCOVID}{When did you test poitive for Covid
#'      \describe{
...
#'        \item{}{Values-1) Within the last four weeks , 2) More than four weeks ago, 3) Both, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-HADCOVIDRV =1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'       \item{TREATORAL}{Received oral antiviral medication
#'      \describe{
#'        \item{}{Question Wording-The FDA has issued emergency use authorizations (EUAs) for a number of treatments for COVID-19 for people at high risk of severe disease. These include oral antiviral medications or pills that can be taken at home, and monoclonal antibody treatments that can be administered at a doctor’s office or hospital. When you had COVID-19 in the past 4 weeks, did you receive an antiviral or monoclonal antibody treatment, such as a pill or IV infusion?}
#'        \item{}{Description-Received oral antiviral medications}
#'        \item{}{Values-1) Yes, received oral antiviral medications (examples: Paxlovid, molnupiravir) , 2) No, did not receive oral antiviral medications (examples: Paxlovid, molnupiravir), -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-HADCOVIDRV = 1 and WHENCOVID in (1,3)}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'     \item{RSNNOTREAT1}{Reason for not taking antivirals or antibodies
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you did not take antivirals or monoclonal antibodies?}
#'        \item{}{Description-Reason for not taking antivirals or monoclonal antibodies}
#'        \item{}{Values-1) I wasn’t very sick/I had no symptoms, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-TREATORAL = 2 and TREATMONO = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{RSNNOTREAT2}{Reason for not taking oral antiviral medication
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you did not take antivirals or monoclonal antibodies?}
#'        \item{}{Description-Reason for not taking antivirals or monoclonal antibodies}
#'        \item{}{Values-1) I didn’t think I needed a treatment, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-TREATORAL = 2 and TREATMONO = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{RSNNOTREAT3}{Reason for not taking oral antiviral medication
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you did not take antivirals or monoclonal antibodies?}
#'        \item{}{Description-Reason for not taking antivirals or monoclonal antibodies}
...
#'   }
#'   }
#'    \item{RSNNOTREAT4}{Reason for not taking oral antiviral medication
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you did not take antivirals or monoclonal antibodies?}
#'        \item{}{Description-Reason for not taking antivirals or monoclonal antibodies}
#'        \item{}{Values-1) My healthcare provider did not offer or recommend them, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-TREATORAL = 2 and TREATMONO = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{RSNNOTREAT5}{Reason for not taking oral antiviral medication
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you did not take antivirals or monoclonal antibodies?}
#'        \item{}{Description-Reason for not taking antivirals or monoclonal antibodies}
#'        \item{}{Values-1) I was concerned about possible side effects of these treatments , -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-TREATORAL = 2 and TREATMONO = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{RSNNOTREAT6}{Reason for not taking oral antiviral medication
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you did not take antivirals or monoclonal antibodies?}
#'        \item{}{Description-Reason for not taking antivirals or monoclonal antibodies}
#'        \item{}{Values-1) I was concerned about cost, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-TREATORAL = 2 and TREATMONO = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{RSNNOTREAT7}{Reason for not taking oral antiviral medication
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you did not take antivirals or monoclonal antibodies?}
#'        \item{}{Description-Reason for not taking antivirals or monoclonal antibodies}
#'        \item{}{Values-1) I didn’t think these treatments were effective, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-TREATORAL = 2 and TREATMONO = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{RSNNOTREAT8}{Reason for not taking oral antiviral medication
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you did not take antivirals or monoclonal antibodies?}
#'        \item{}{Description-Reason for not taking antivirals or monoclonal antibodies}
#'        \item{}{Values-1) It was hard for me or my healthcare provider to get them, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-TREATORAL = 2 and TREATMONO = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{RSNNOTREAT9}{Reason for not taking oral antiviral medication
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you did not take antivirals or monoclonal antibodies?}
#'        \item{}{Description-Reason for not taking antivirals or monoclonal antibodies}
#'        \item{}{Values-1) I hadn’t heard of them, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-TREATORAL = 2 and TREATMONO = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{RSNNOTREAT10}{Reason for not taking oral antiviral medication
#'      \describe{
#'        \item{}{Question Wording-Which of the following, if any, are reasons that you did not take antivirals or monoclonal antibodies?}
#'        \item{}{Description-Reason for not taking antivirals or monoclonal antibodies}
#'        \item{}{Values-1) Other (please specify) _____, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-TREATORAL = 2 and TREATMONO = 2}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'   }
#'   }
#'    \item{KIDBHVR1}{Child behavior 1
#'      \describe{
#'        \item{}{Question Wording-Think about all of the children living in your household. IN THE PAST 4 WEEKS, did any of these children seem to (check all that apply):}
#'        \item{}{Description-Feeling anxious}
#'        \item{}{Values-1) Feel anxious or clingy?, -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-HHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{KIDBHVR2}{Child behavior 2
#'      \describe{
#'        \item{}{Question Wording-Think about all of the children living in your household. IN THE PAST 4 WEEKS, did any of these children seem to (check all that apply):}
#'        \item{}{Description-feeling sad or depressed}
#'        \item{}{Values-1) Feel very sad or depressed? , -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-HHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{KIDBHVR3}{Child behavior 3
#'      \describe{
#'        \item{}{Question Wording-Think about all of the children living in your household. IN THE PAST 4 WEEKS, did any of these children seem to (check all that apply):}
#'        \item{}{Description-Changes to eating habbits}
#'        \item{}{Values-1) Show changes in eating behaviors, such as eating more or less than normal, or became extremely picky?,-99) Question seen but category not selected}
#'        \item{}{Universe-HHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{KIDBHVR4}{Child behavior 4
#'      \describe{
#'        \item{}{Question Wording-Think about all of the children living in your household. IN THE PAST 4 WEEKS, did any of these children seem to (check all that apply):}
#'        \item{}{Description-Ability to focus}
#'        \item{}{Values-1) Show changes in their ability to stay focused, such as becoming easily distracted?,-99) Question seen but category not selected}
#'        \item{}{Universe-HHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{KIDBHVR5}{Child behavior 5
#'      \describe{
#'        \item{}{Question Wording-Think about all of the children living in your household. IN THE PAST 4 WEEKS, did any of these children seem to (check all that apply):}
#'        \item{}{Description-Signs of anger }
#'        \item{}{Values-1) Show unusual anger or outbursts?, -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-HHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{KIDBHVR6}{Child behavior 6
#'      \describe{
#'        \item{}{Question Wording-Think about all of the children living in your household. IN THE PAST 4 WEEKS, did any of these children seem to (check all that apply):}
#'        \item{}{Description-Siggns of problematic behaviour }
#'        \item{}{Values-1) Engage in problematic behaviors such as lying, cheating, stealing, or bullying?, -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-HHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'     \item{KIDBHVR7}{Child behavior 7
#'      \describe{
#'        \item{}{Question Wording-Think about all of the children living in your household. IN THE PAST 4 WEEKS, did any of these children seem to (check all that apply):}
#'        \item{}{Description-Developemental regression}
#'        \item{}{Values-1) Behave in ways that they’ve previously outgrown, such as thumb sucking or wetting the bed?, -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-HHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'     \item{KIDBHVR8}{Child behavior 8
#'      \describe{
#'        \item{}{Question Wording-Think about all of the children living in your household. IN THE PAST 4 WEEKS, did any of these children seem to (check all that apply):}
#'        \item{}{Description-Unspeciffic physical pain}
#'        \item{}{Values-1) Complain of physical pain with no medical issue such as stomach aches or pains?, -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-HHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'    \item{KIDBHVR9}{Child behavior 9
#'      \describe{
#'        \item{}{Question Wording-Think about all of the children living in your household. IN THE PAST 4 WEEKS, did any of these children seem to (check all that apply):}
#'        \item{}{Description-No changes in behaviour}
#'        \item{}{Values-1) None of the children in my household exhibited any of these behaviors, -99) Question seen but category not selected, -88)Missing / Did not report}
#'        \item{}{Universe-HHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'   }
#'   }
#'    \item{TRENTAMT}{Monthly Rent
#'      \describe{
#'        \item{}{Question Wording-What is your current monthly rent?}
...
#'   }
#'   }
#'    \item{RCVEDUC9}{Children education
#'      \describe{
#'        \item{}{Question Wording-During the last 7 days, how did the children in this household receive their education?  Select all that apply.}
#'        \item{}{Description-How children received education}
#'        \item{}{Values-1) Other__Specify, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-If ENROLLPUB > 0  or ENROLLPRV > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{TREATMONO}{Monoclonal treatment
#'      \describe{
#'        \item{}{Question Wording-The FDA has issued emergency use authorizations (EUAs) for a number of treatments for COVID-19 for people at high risk of severe disease. These include oral antiviral medications or pills that can be taken at home, and monoclonal antibody treatments that can be administered at a doctor’s office or hospital. When you had COVID-19 in the past 4 weeks, did you receive an antiviral or monoclonal antibody treatment, such as a pill or IV infusion?}
#'        \item{}{Description-Received  monoclonal antibody treatments}
#'        \item{}{Values-1) Yes, received monoclonal antibody treatments (example: sotrovimab), 2) No, did not receive monoclonal antibody treatments (example: sotrovimab), -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-HADCOVIDRV = 1 and WHENCOVID in (1,3)}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'   }
#'   }
#'   \item{KIDGETVAC_LT5Y}{Children 5 to 11 intention on getting vaccine
#'      \describe{
#'        \item{}{Question Wording-Now that vaccines to prevent COVID-19 are available to most children, will the parents or guardians of children living in your household…}
#'        \item{}{Description-likelihood of getting vaccinated (less than 5 years old)}
#'        \item{}{Values-1) Definitely get the children a vaccine,2) Probably get the children a vaccine,3) Be unsure about getting the children a vaccine,4) Probably NOT get the children a vaccine ,5) Definitely NOT get the children a vaccine,6) I do not know the plans for vaccination of the children under 5 in my household,-99) Question seen but category not selected,-88) Missing / Did not report}
#'        \item{}{Universe-KIDDOSESRV=2}
#'        \item{}{Internal Notes-}
#'   }
...
#'   }
#'   }
#'   \item{CCARETYP1}{Childcare arrangements 1
#'      \describe{
#'        \item{}{Question Wording-In the last 7 days, did your household use any of the following individuals or arrangements to look after the children in the household. Select all that apply.}
#'        \item{}{Description-Childcare arrangements in last 7 days}
#'        \item{}{Values-1) Family day care provider caring for 2 or more children outside of your home? , -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-THHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{CCARETYP2}{Childcare arrangements 2
#'      \describe{
#'        \item{}{Question Wording-In the last 7 days, did your household use any of the following individuals or arrangements to look after the children in the household. Select all that apply.}
#'        \item{}{Description-Childcare arrangements in last 7 days}
#'        \item{}{Values-1) Child care or day care center?, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-THHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{CCARETYP3}{Childcare arrangements 3
#'      \describe{
#'        \item{}{Question Wording-In the last 7 days, did your household use any of the following individuals or arrangements to look after the children in the household. Select all that apply.}
#'        \item{}{Description-Childcare arrangements in last 7 days}
#'        \item{}{Values-1) Nursery or preschool?, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-THHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{CCARETYP4}{Childcare arrangements 4
#'      \describe{
#'        \item{}{Question Wording-In the last 7 days, did your household use any of the following individuals or arrangements to look after the children in the household. Select all that apply.}
#'        \item{}{Description-Childcare arrangements in last 7 days}
#'        \item{}{Values-1) Before care, aftercare, or summer camp?, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-THHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{CCARETYP5}{Childcare arrangements 5
#'      \describe{
#'        \item{}{Question Wording-In the last 7 days, did your household use any of the following individuals or arrangements to look after the children in the household. Select all that apply.}
#'        \item{}{Description-Childcare arrangements in last 7 days}
#'        \item{}{Values-1) Federally supported Head Start program?, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-THHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{CCARETYP6}{Childcare arrangements 6
#'      \describe{
#'        \item{}{Question Wording-In the last 7 days, did your household use any of the following individuals or arrangements to look after the children in the household. Select all that apply.}
#'        \item{}{Description-Childcare arrangements in last 7 days}
#'        \item{}{Values-1) Non-relative such as a friend, neighbor, sitter, nanny, or aupair?, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-THHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{CCARETYP7}{Childcare arrangements 7
#'      \describe{
#'        \item{}{Question Wording-In the last 7 days, did your household use any of the following individuals or arrangements to look after the children in the household. Select all that apply.}
#'        \item{}{Description-Childcare arrangements in last 7 days}
#'        \item{}{Values-1) Relative other than the parent, such as sibling, or grandparent? , -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-THHLD_NUMKID > 0}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{CCARETYP8}{Childcare arrangements 8
#'      \describe{
#'        \item{}{Question Wording-In the last 7 days, did your household use any of the following individuals or arrangements to look after the children in the household. Select all that apply.}
#'        \item{}{Description-Childcare arrangements in last 7 days}
...
#'   }
#'   }
#'   \item{CCAREPAY}{Childcare payment
#'      \describe{
#'        \item{}{Question Wording-When the children were in these care settings, did you or anyone in the household PAY for childcare? Select only one answer.}
#'        \item{}{Description-Payment for childcare arrangements in last 7 days}
#'        \item{}{Values-1) Yes, 2) No, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-CCARETYP1 = 1 or CCARETYP2 = 1 or CCARETYP3 = 1 or CCARETYP4 = 1 or CCARETYP5 = 1 or CCARETYP6 = 1 or CCARETYP7 = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{TCCARECOST}{Childcare cost
#'      \describe{
#'        \item{}{Question Wording-In the last 7 days, how much did your household pay for all the childcare together?}
#'        \item{}{Description-Cost of childcare arrangements in last 7 days}
#'        \item{}{Values-$0-$3000, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-CCARETYP1 = 1 or CCARETYP2 = 1 or CCARETYP3 = 1 or CCARETYP4 = 1 or CCARETYP5 = 1 or CCARETYP6 = 1 or CCARETYP7 = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'        \item{}{Description-Infants younger than 1 year in household}
#'        \item{}{Values-1) Yes, 2) No, -99) Question seen but category not selected, -88) Missing / Did not report}
...
#'        \item{}{Values-1) Under 6 months?, 2) Between 6 months and 9 months?, 3) Between 9 months and 12 months?, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_AFFCT}{Formula shortage effect
#'      \describe{
#'        \item{}{Question Wording-Was your household affected by the Infant Formula shortage this year?}
#'        \item{}{Description-Household affected by the infant formula shortage}
#'        \item{}{Values-1) Yes, 2) No, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_DEAL1}{Formula shortage dealing 1
#'      \describe{
#'        \item{}{Question Wording-Please state how you dealt with the infant formula shortage this year: (Select all that apply)}
#'        \item{}{Description-How household dealt with the infant formula shortage}
#'        \item{}{Values-1) Increased breastfeeding, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1 and FRMLA_AFFCT = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_DEAL2}{Formula shortage dealing 2
#'      \describe{
#'        \item{}{Question Wording-Please state how you dealt with the infant formula shortage this year: (Select all that apply)}
#'        \item{}{Description-How household dealt with the infant formula shortage}
#'        \item{}{Values-1) Changed from powder to liquid (i.e., liquid concentrate or ready-to-feed (RTF)), -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1 and FRMLA_AFFCT = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_DEAL3}{Formula shortage dealing 3
#'      \describe{
#'        \item{}{Question Wording-Please state how you dealt with the infant formula shortage this year: (Select all that apply)}
#'        \item{}{Description-How household dealt with the infant formula shortage}
#'        \item{}{Values-1) Got Infant Formula at a different store than where I usually shop, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1 and FRMLA_AFFCT = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_DEAL4}{Formula shortage dealing 4
#'      \describe{
#'        \item{}{Question Wording-Please state how you dealt with the infant formula shortage this year: (Select all that apply)}
#'        \item{}{Description-How household dealt with the infant formula shortage}
#'        \item{}{Values-1) Got Infant Formula online (e.g., Instacart, Amazon, Google Market, secondary market, or other), -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1 and FRMLA_AFFCT = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_DEAL5}{Formula shortage dealing 5
#'      \describe{
#'        \item{}{Question Wording-Please state how you dealt with the infant formula shortage this year: (Select all that apply)}
#'        \item{}{Description-How household dealt with the infant formula shortage}
#'        \item{}{Values-1) Received direct shipment of Infant Formula from the Infant Formula company, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1 and FRMLA_AFFCT = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_DEAL6}{Formula shortage dealing 6
#'      \describe{
#'        \item{}{Question Wording-Please state how you dealt with the infant formula shortage this year: (Select all that apply)}
#'        \item{}{Description-How household dealt with the infant formula shortage}
#'        \item{}{Values-1) Changed to a different brand of Infant Formula (any form, powder or liquid), -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1 and FRMLA_AFFCT = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_DEAL7}{Formula shortage dealing 7
#'      \describe{
#'        \item{}{Question Wording-Please state how you dealt with the infant formula shortage this year: (Select all that apply)}
#'        \item{}{Description-How household dealt with the infant formula shortage}
#'        \item{}{Values-1) Changed from Infant Formula to something else (for example: Cow milk, Goat milk, Soy milk, Almond milk, Oat milk, or Toddler Drink/Formula), -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1 and FRMLA_AFFCT = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_DEAL8}{Formula shortage dealing 8
#'      \describe{
#'        \item{}{Question Wording-Please state how you dealt with the infant formula shortage this year: (Select all that apply)}
#'        \item{}{Description-How household dealt with the infant formula shortage}
#'        \item{}{Values-1) Stopped offering Infant Formula, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1 and FRMLA_AFFCT = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_DEAL9}{Formula shortage dealing 9
#'      \describe{
#'        \item{}{Question Wording-Please state how you dealt with the infant formula shortage this year: (Select all that apply)}
#'        \item{}{Description-How household dealt with the infant formula shortage}
#'        \item{}{Values-1) Watering down formula or “making your own” formula, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1 and FRMLA_AFFCT = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_DEAL10}{Formula shortage dealing 10
#'      \describe{
#'        \item{}{Question Wording-Please state how you dealt with the infant formula shortage this year: (Select all that apply)}
#'        \item{}{Description-How household dealt with the infant formula shortage}
...
#'   }
#'   }
#'   \item{FRMLA_USE}{Baby typically use formula
#'      \describe{
#'        \item{}{Question Wording-Does the baby typically use Infant Formula?}
#'        \item{}{Description-Baby typically use formula}
#'        \item{}{Values-1) Yes, 2) No, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1 }
#'        \item{}{Internal Notes-}
#'   }
...
#'        \item{}{Values-1) Yes, 2) No, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1  and FRMLA_USE = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_AMNT}{Amount of formula on hand
#'      \describe{
#'        \item{}{Question Wording-Currently, how much Infant Formula do you have on hand?}
#'        \item{}{Description-Amount of formula on hand}
#'        \item{}{Values-1) None , 2) Formula for less than a week, 3) Formula for about a week, 4) Formula for more than a week, 5) Formula for more than two weeks, -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1 and FRMLA_USE = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_TYP1}{Formula used 1
#'      \describe{
#'        \item{}{Question Wording-What type of Infant Formula does your infant typically use? Mark all that apply}
#'        \item{}{Description-Typical formula used}
#'        \item{}{Values-1) Regular or Routine Infant Formula (e.g Similac, Enfamil, Enfagrow, Pregestimil, Enfaport, NAN, Good Start, NIDO, KLIM, Earths Best, Happy Baby, Burts Bees, Kabrita, Babys Only, Else, Lil Mixins, Babys Choice, Kendamil, J&J Sunrise, PediaSmart, Family Wellness, Happy Tot, Store Label, Private Label), -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1  and FRMLA_USE = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_TYP2}{Formula used 2
#'      \describe{
#'        \item{}{Question Wording-What type of Infant Formula does your infant typically use? Mark all that apply}
#'        \item{}{Description-Typical formula used}
#'        \item{}{Values-1) Extensively Hydrolyzed Infant Formula (e.g., Alimentum, Alimentum Liquid, Gerber Extensive, Nutramigen), -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1  and FRMLA_USE = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_TYP3}{Formula used 3
#'      \describe{
#'        \item{}{Question Wording-What type of Infant Formula does your infant typically use? Mark all that apply}
#'        \item{}{Description-Typical formula used}
#'        \item{}{Values-1) Amino Acid Based Infant Formula (e.g., Alfamino, EleCare, Neocate, Puramino), -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1  and FRMLA_USE = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
#'   \item{FRMLA_TYP4}{Formula used 4
#'      \describe{
#'        \item{}{Question Wording-What type of Infant Formula does your infant typically use? Mark all that apply}
#'        \item{}{Description-Typical formula used}
#'        \item{}{Values-1) Metabolic Infant Formulas (e.g., Calcilo, Cyclinex-1,  Glutarex-1,  Hominex-1, I-Valex-1, Ketonex-1, Phenex-1,  Pro-Phree, Propimex-1,  RCF, Tyrex-1), -99) Question seen but category not selected, -88) Missing / Did not report}
#'        \item{}{Universe-FRMLA_YN = 1  and FRMLA_USE = 1}
#'        \item{}{Internal Notes-}
#'   }
#'   }
...
#'      \describe{
#'        \item{}{Question Wording-After the end of the normal school year in the Spring of 2022, did any of the Kindergarten through 12th grade students in your household: Please select all that apply.}
...
#'   }
#'   }
#'   \item{SUMMER_ED5}{Summer education 5
#'      \describe{
#'        \item{}{Question Wording-After the end of the normal school year in the Spring of 2022, did any of the Kindergarten through 12th grade students in your household: Please select all that apply.}
#'        \item{}{Description-Summer educational catch-up activities}
#'        \item{}{Values-1) None of these, -99) Question seen but category not selected, -88) Missing / Did not report}
